	...
	_logger (xefis.logger())
{
	...
	auto& test_generator_hsi_range											= test_generator_io->create_enum_socket<si::Length> ("hsi/range", { { 5_nmi, 10_s }, { 20_nmi, 10_s }, { 40_nmi, 4_s }, { 80_nmi, 2_s }, { 160_nmi, 2_s } });
	auto& test_generator_hsi_speed_gs										= test_generator_io->create_socket<si::Velocity> ("hsi/speed/ground-speed", 0_kt, { 0_kt, 400_kt }, 13_kt / 1_s);
	auto& test_generator_hsi_speed_tas										= test_generator_io->create_socket<si::Velocity> ("hsi/speed/true-airspeed", 0_kt, { 0_kt, 400_kt }, 17_kt / 1_s);
	...
	auto& test_generator_hsi_target_altitude_reach_distance					= test_generator_io->create_socket<si::Length> ("hsi/target-altitude-reach-distance", 12_nmi, { 12_nmi, 15_nmi }, 0.5_nmi / 1_s);
	auto& test_generator_hsi_orientation_heading_magnetic					= test_generator_io->create_socket<si::Angle> ("hsi/orientation/heading.magnetic", 0_deg, { 0_deg, 360_deg }, 2_deg / 1_s, TestGeneratorIO::BorderCondition::Periodic);
	auto& test_generator_hsi_orientation_heading_true						= test_generator_io->create_socket<si::Angle> ("hsi/orientation/heading.true", 10_deg, { 0_deg, 360_deg }, 2_deg / 1_s, TestGeneratorIO::BorderCondition::Periodic);
	auto  test_generator_hsi_heading_mode									= hsi::HeadingMode::Magnetic;
	auto& test_generator_hsi_home_true_direction							= test_generator_io->create_socket<si::Angle> ("hsi/home/true-direction", 0_deg, { 0_deg, 360_deg }, 5_deg / 1_s, TestGeneratorIO::BorderCondition::Periodic);
	auto  test_generator_hsi_home_track_visible								= true;
	auto& test_generator_hsi_home_distance_vlos								= test_generator_io->create_socket<si::Length> ("hsi/home/distance/vlos", 0_m, { 0_m, 30_km }, 150_m / 1_s);
	auto& test_generator_hsi_home_distance_ground							= test_generator_io->create_socket<si::Length> ("hsi/home/distance/ground", 0_m, { 0_m, 20_km }, 100_m / 1_s);
	auto& test_generator_hsi_home_distance_vertical							= test_generator_io->create_socket<si::Length> ("hsi/home/distance/vertical", 0_m, { 0_m, 5_km }, 25_m / 1_s);
	auto  test_generator_hsi_home_position_longitude						= 51.9_deg;
	auto  test_generator_hsi_home_position_latitude							= 19.14_deg;
	auto& test_generator_hsi_position_longitude								= test_generator_io->create_socket<si::Angle> ("hsi/position/longitude", 51.9_deg, { 51.9_deg, 60_deg }, 0.001_deg / 1_s);
	auto& test_generator_hsi_position_latitude								= test_generator_io->create_socket<si::Angle> ("hsi/position/latitude", 19.14_deg, { 19.14_deg, 20.14_deg }, 0.001_deg / 1_s);
	auto  test_generator_hsi_position_source								= "GPS";
	auto& test_generator_hsi_range_warning_longitude						= test_generator_io->create_socket<si::Angle> ("hsi/range/warning/longitude", 51.9_deg, { 51.9_deg, 60_deg }, 0.002_deg / 1_s);
	auto& test_generator_hsi_range_warning_latitude							= test_generator_io->create_socket<si::Angle> ("hsi/range/warning/latitude", 19.14_deg, { 19.14_deg, 20.14_deg }, 0.002_deg / 1_s);
	auto& test_generator_hsi_range_warning_radius							= test_generator_io->create_socket<si::Length> ("hsi/range/warning/radius", 10_nmi, { 0_nmi, 10_nmi }, 0.1_nmi / 1_s);
	auto& test_generator_hsi_range_critical_longitude						= test_generator_io->create_socket<si::Angle> ("hsi/range/critical/longitude", 51.9_deg, { 51.9_deg, 60_deg }, 0.002_deg / 1_s);
	auto& test_generator_hsi_range_critical_latitude						= test_generator_io->create_socket<si::Angle> ("hsi/range/critical/latitude", 19.14_deg, { 19.14_deg, 20.14_deg }, 0.002_deg / 1_s);
	auto& test_generator_hsi_range_critical_radius							= test_generator_io->create_socket<si::Length> ("hsi/range/critical/radius", 14_nmi, { 0_nmi, 14_nmi }, 0.1_nmi / 1_s);
	auto  test_generator_hsi_track_visible									= true;
	auto& test_generator_hsi_track_lateral_magnetic							= test_generator_io->create_socket<si::Angle> ("hsi/orientation/heading.magnetic", -5_deg, { -5_deg, 355_deg }, 2_deg / 1_s, TestGeneratorIO::BorderCondition::Periodic);
	auto  test_generator_hsi_track_lateral_rotation							= -1_deg / 1_s;
	auto  test_generator_hsi_track_center_on_track							= true;
	auto& test_generator_hsi_course_visible									= test_generator_io->create_enum_socket<bool> ("hsi/course/visible", { { true, 16_s }, { false, 2_s } });
	auto& test_generator_hsi_course_setting_magnetic						= test_generator_io->create_socket<si::Angle> ("hsi/course/setting.magnetic", 0_deg, { 0_deg, 720_deg }, 20_deg / 1_s);
	auto& test_generator_hsi_course_deviation								= test_generator_io->create_socket<si::Angle> ("hsi/course/deviation", 0_deg, { -10_deg, +10_deg }, 1_deg / 1_s);
	auto& test_generator_hsi_course_to_flag									= test_generator_io->create_enum_socket<bool> ("hsi/course/to-flag", { { true, 7_s }, { false, 3_s } });
	auto  test_generator_hsi_navaid_selected_reference						= "REF";
	auto  test_generator_hsi_navaid_selected_identifier						= "IDENT";
	auto& test_generator_hsi_navaid_selected_distance						= test_generator_io->create_socket<si::Length> ("hsi/navaid/selected/distance", 0_nmi, { 0_nmi, 5_nmi }, 0.15_nmi / 1_s);
	auto& test_generator_hsi_navaid_selected_eta							= test_generator_io->create_socket<si::Time> ("hsi/navaid/selected/eta", 300_s, { 0_s, 300_s }, 1_s / 1_s);
	auto& test_generator_hsi_navaid_selected_course_magnetic				= test_generator_io->create_socket<si::Angle> ("hsi/navaid/selected/course-magnetic", 27_deg, { 23_deg, 31_deg },0.5_deg / 1_s);
	...
	auto& test_generator_hsi_navaid_left_distance							= test_generator_io->create_socket<si::Length> ("hsi/navaid/left/distance", 0_nmi, { 0_nmi, 5_nmi }, 0.1_nmi / 1_s);
	auto& test_generator_hsi_navaid_left_initial_bearing_magnetic			= test_generator_io->create_socket<si::Angle> ("hsi/navaid/left/initial-bearing-magnetic", 30_deg, { 28_deg, 32_deg }, 0.25_deg / 1_s);
	...
	auto& test_generator_hsi_navaid_right_distance							= test_generator_io->create_socket<si::Length> ("hsi/navaid/right/distance", 100_nmi, { 100_nmi, 105_nmi }, 0.1_nmi / 1_s);
	auto& test_generator_hsi_navaid_right_initial_bearing_magnetic			= test_generator_io->create_socket<si::Angle> ("hsi/navaid/right/initial-bearing-magnetic", 80_deg, { 78_deg, 82_deg }, 0.25_deg / 1_s);
	auto  test_generator_hsi_navigation_required_performance				= 4_m;
	auto  test_generator_hsi_navigation_actual_performance					= 1.2_m;
	auto& test_generator_hsi_wind_from_magnetic								= test_generator_io->create_socket<si::Angle> ("hsi/wind/from-magnetic", 100_deg, { 0_deg, 360_deg }, 2_deg / 1_s);
	auto& test_generator_hsi_wind_speed_tas									= test_generator_io->create_socket<si::Velocity> ("hsi/wind/speed-tas", 12_kt, { 10_kt, 15_kt }, 0.1_kt / 1_s);
	auto  test_generator_hsi_localizer_id									= "LOCID";
	auto& test_generator_hsi_tcas_on										= test_generator_io->create_enum_socket<bool> ("hsi/tcas/on", { { true, 5_s }, { false, 3_s } });
	auto& test_generator_hsi_tcas_range										= test_generator_io->create_enum_socket<si::Length> ("hsi/tcas/range", { { 3_nmi, 2_s }, { 6_nmi, 2_s }, { 9_nmi, 2_s }, { 12_nmi, 2_s } });
	auto& test_generator_hsi_features_fix									= test_generator_io->create_enum_socket<bool> ("hsi/features/fix", { { true, 3_s }, { true, 10_s }, { false, 1_s } });
	auto& test_generator_hsi_features_vor									= test_generator_io->create_enum_socket<bool> ("hsi/features/vor", { { true, 5_s }, { true, 10_s }, { false, 1_s } });
	auto& test_generator_hsi_features_dme									= test_generator_io->create_enum_socket<bool> ("hsi/features/dme", { { true, 7_s }, { true, 10_s }, { false, 1_s } });
	auto& test_generator_hsi_features_ndb									= test_generator_io->create_enum_socket<bool> ("hsi/features/ndb", { { true, 9_s }, { true, 10_s }, { false, 1_s } });
	auto& test_generator_hsi_features_loc									= test_generator_io->create_enum_socket<bool> ("hsi/features/loc", { { true, 11_s }, { true, 10_s }, { false, 1_s } });
	auto& test_generator_hsi_features_arpt									= test_generator_io->create_enum_socket<bool> ("hsi/features/arpt", { { true, 13_s }, { true, 10_s }, { false, 1_s } });
	auto& test_generator_hsi_radio_range_warning							= test_generator_io->create_socket<si::Length> ("hsi/radio-range/range.warning", 7_mi, { 6_mi, 8_mi }, 0.1_mi / 1_s);
	auto& test_generator_hsi_radio_range_critical							= test_generator_io->create_socket<si::Length> ("hsi/radio-range/range.critical", 10_mi, { 8_mi, 11_mi }, 0.1_mi / 1_s);
	...
	test_screen_1->adi_io->speed_ias_maximum_maneuver						<< test_generator_io->create_socket<si::Velocity> ("adi/speed/ias.maximum.maneuver", 245_kt, { 238_kt, 245_kt }, 3_kt / 1_s);
	test_screen_1->adi_io->speed_ias_maximum								<< test_generator_io->create_socket<si::Velocity> ("adi/speed/ias.maximum", 250_kt, { 240_kt, 260_kt }, 3_kt / 1_s);
	test_screen_1->adi_io->speed_mach										<< test_generator_io->create_socket<double> ("adi/speed/mach", 0.0f, { 0.0f, 0.85f }, 0.025f / 1_s);
	test_screen_1->adi_io->speed_ground										<< test_generator_io->create_socket<si::Velocity> ("adi/speed/ground-speed", 0_kt, { 0_kt, 400_kt }, 13_kt / 1_s);
	test_screen_1->adi_io->speed_v1											<< test_generator_io->create_socket<si::Velocity> ("adi/speed-bugs/v1", 80_kt, { 78_kt, 82_kt }, 1_kt / 1_s);
	test_screen_1->adi_io->speed_vr											<< test_generator_io->create_socket<si::Velocity> ("adi/speed-bugs/vr", 88_kt, { 86_kt, 89_kt }, 1_kt / 1_s);
	test_screen_1->adi_io->speed_vref										<< test_generator_io->create_socket<si::Velocity> ("adi/speed-bugs/vref", 95_kt, { 94_kt, 96_kt }, 0.1_kt / 1_s);
	test_screen_1->adi_io->speed_flaps_up_label								<< "UP";
	test_screen_1->adi_io->speed_flaps_up_speed								<< 140_kt;
	test_screen_1->adi_io->speed_flaps_a_label								<< "1";
	...
	test_screen_1->adi_io->track_lateral_magnetic							<< test_generator_io->create_socket<si::Angle> ("adi/track/lateral.magnetic", 9_deg, { 0_deg, 360_deg }, 22_deg / 1_s, TestGeneratorIO::BorderCondition::Periodic);
	test_screen_1->adi_io->track_lateral_true								<< test_generator_io->create_socket<si::Angle> ("adi/track/lateral.true", 19_deg, { 0_deg, 360_deg }, 22_deg / 1_s, TestGeneratorIO::BorderCondition::Periodic);
	test_screen_1->adi_io->track_vertical									<< test_generator_io->create_socket<si::Angle> ("adi/track/vertical", 0_deg, { -13_deg, 13_deg }, 1_deg / 1_s);
	test_screen_1->adi_io->fpv_visible										<< true;
	test_screen_1->adi_io->slip_skid										<< test_generator_io->create_socket<si::Angle> ("adi/slip-skid/angle", 0_deg, { -5_deg, 5_deg }, 0.5_deg / 1_s);
	...
	test_screen_1->adi_io->decision_height_type								<< test_generator_io->create_enum_socket<std::string> ("adi/decision-height/type", { { "BARO", 5_s }, { "RADIO", 4_s } });
	...
	test_screen_1->adi_io->pressure_use_std									<< test_generator_io->create_enum_socket<bool> ("adi/pressure/use-std", { { true, 4_s }, { false, 4_s } });
	test_screen_1->adi_io->flight_director_serviceable						<< test_generator_io->create_enum_socket<bool> ("adi/flight-director/serviceable", { { true, 13_s }, { false, 2_s } });
	test_screen_1->adi_io->flight_director_active_name						<< test_generator_io->create_enum_socket<std::string> ("adi/flight-director/active-name", { { "L", 3_s }, { "R", 3_s }, { "", 2_s } });
	test_screen_1->adi_io->flight_director_cmd_visible						<< true;
	test_screen_1->adi_io->flight_director_cmd_altitude						<< 1000_ft;
	test_screen_1->adi_io->flight_director_cmd_altitude_acquired			<< false;
	test_screen_1->adi_io->flight_director_cmd_ias							<< 100_kt;
	test_screen_1->adi_io->flight_director_cmd_mach							<< 0.34;
	test_screen_1->adi_io->flight_director_cmd_vertical_speed				<< 1500_fpm;
	test_screen_1->adi_io->flight_director_cmd_fpa							<< 5_deg;
	test_screen_1->adi_io->flight_director_guidance_visible					<< true;
	test_screen_1->adi_io->flight_director_guidance_pitch					<< 2.5_deg;
	test_screen_1->adi_io->flight_director_guidance_roll					<< 0_deg;
	test_screen_1->adi_io->control_surfaces_visible							<< true;
	test_screen_1->adi_io->control_surfaces_elevator						<< test_generator_io->create_socket<double> ("adi/control-surfaces/elevator", 0.0f, { -1.0f, +1.0f }, 0.1f / 1_s);
	test_screen_1->adi_io->control_surfaces_ailerons						<< test_generator_io->create_socket<double> ("adi/control-surfaces/ailerons", 0.0f, { -1.0f, +1.0f }, 0.3f / 1_s);
	test_screen_1->adi_io->navaid_reference_visible							<< true;
	test_screen_1->adi_io->navaid_course_magnetic							<< 150_deg;
	test_screen_1->adi_io->navaid_type_hint									<< "VOR";
	test_screen_1->adi_io->navaid_identifier								<< "WRO";
	test_screen_1->adi_io->navaid_distance									<< 1.5_nmi;
	test_screen_1->adi_io->flight_path_deviation_lateral_serviceable		<< test_generator_io->create_enum_socket<bool> ("adi/flight-path-deviation/lateral/serviceable", { { true, 9.5_s }, { false, 2_s } });
	test_screen_1->adi_io->flight_path_deviation_lateral_approach			<< test_generator_io->create_socket<si::Angle> ("adi/flight-path-deviation/lateral/approach", 0_deg, { -5_deg, 5_deg }, 1_deg / 1_s);
	test_screen_1->adi_io->flight_path_deviation_lateral_flight_path		<< test_generator_io->create_socket<si::Angle> ("adi/flight-path-deviation/lateral/flight-path", 0_deg, { -5_deg, 5_deg }, 2_deg / 1_s);
	test_screen_1->adi_io->flight_path_deviation_vertical_serviceable		<< test_generator_io->create_enum_socket<bool> ("adi/flight-path-deviation/vertical/serviceable", { { true, 13.4_s }, { false, 2_s } });
	test_screen_1->adi_io->flight_path_deviation_vertical					<< test_generator_io->create_socket<si::Angle> ("adi/flight-path-deviation/vertical/deviation", 0_deg, { -5_deg, 5_deg }, 1_deg / 1_s);
	test_screen_1->adi_io->flight_path_deviation_vertical_approach			<< test_generator_io->create_socket<si::Angle> ("adi/flight-path-deviation/vertical/approach", 0_deg, { -5_deg, 5_deg }, 2_deg / 1_s);
	test_screen_1->adi_io->flight_path_deviation_vertical_flight_path		<< test_generator_io->create_socket<si::Angle> ("adi/flight-path-deviation/vertical/flight-path", 0_deg, { -5_deg, 5_deg }, 3_deg / 1_s);
	test_screen_1->adi_io->flight_path_deviation_mixed_mode					<< true;
	test_screen_1->adi_io->flight_mode_hint_visible							<< true;
	test_screen_1->adi_io->flight_mode_hint									<< test_generator_io->create_enum_socket<std::string> ("adi/fma/hint", { { "F/D", 11_s }, { "CMD", 15_s } });
	test_screen_1->adi_io->flight_mode_fma_visible							<< true;
	test_screen_1->adi_io->flight_mode_fma_speed_hint						<< test_generator_io->create_enum_socket<std::string> ("adi/fma/speed-hint", { { std::string (afcs::kThrustMode_TO_GA), 15_s }, { std::string (afcs::kThrustMode_Continuous), 15_s } });
	test_screen_1->adi_io->flight_mode_fma_speed_armed_hint					<< test_generator_io->create_enum_socket<std::string> ("adi/fma/speed-armed-hint", { { std::string (afcs::kSpeedMode_Airspeed), 17_s }, { std::string (afcs::kSpeedMode_Thrust), 17_s } });
	test_screen_1->adi_io->flight_mode_fma_lateral_hint						<< test_generator_io->create_enum_socket<std::string> ("adi/fma/lateral-hint", { { std::string (afcs::kRollMode_Track), 12_s }, { std::string (afcs::kRollMode_WingsLevel), 12_s }, { std::string (afcs::kRollMode_LNAV), 15_s }, { std::string (afcs::kRollMode_Localizer), 12_s } });
	test_screen_1->adi_io->flight_mode_fma_lateral_armed_hint				<< test_generator_io->create_enum_socket<std::string> ("adi/fma/lateral-armed-hint", { { std::string (afcs::kRollMode_Track), 13_s }, { std::string (afcs::kRollMode_Heading), 13_s } });
	test_screen_1->adi_io->flight_mode_fma_vertical_hint					<< test_generator_io->create_enum_socket<std::string> ("adi/fma/vertical-hint", { { std::string (afcs::kPitchMode_Altitude), 11_s }, { std::string (afcs::kPitchMode_TO_GA), 17_s } });
	test_screen_1->adi_io->flight_mode_fma_vertical_armed_hint				<< test_generator_io->create_enum_socket<std::string> ("adi/fma/vertical-armed-hint", { { std::string (afcs::kPitchMode_GS), 14_s }, { std::string (afcs::kPitchMode_VNAVPath), 14_s } });
	test_screen_1->adi_io->tcas_resolution_advisory_pitch_minimum			<< -45_deg;
	test_screen_1->adi_io->tcas_resolution_advisory_pitch_maximum			<< 80_deg;
	test_screen_1->adi_io->tcas_resolution_advisory_vertical_speed_minimum	<< -3000_fpm;
	test_screen_1->adi_io->tcas_resolution_advisory_vertical_speed_maximum	<< 10000_fpm;
	test_screen_1->adi_io->warning_novspd_flag								<< test_generator_io->create_enum_socket<bool> ("adi/flags/novspd", { { false, 3_s }, { true, 2_s } });
	test_screen_1->adi_io->warning_ldgalt_flag								<< test_generator_io->create_enum_socket<bool> ("adi/flags/ldgalt", { { false, 7_s }, { true, 2_s } });
	test_screen_1->adi_io->warning_pitch_disagree							<< test_generator_io->create_enum_socket<bool> ("adi/flags/pitch-disagree", { { false, 5_s }, { true, 2_s } });
	test_screen_1->adi_io->warning_roll_disagree							<< test_generator_io->create_enum_socket<bool> ("adi/flags/roll-disagree", { { false, 4_s }, { true, 2_s } });
	test_screen_1->adi_io->warning_ias_disagree								<< test_generator_io->create_enum_socket<bool> ("adi/flags/ias-disagree", { { false, 9_s }, { true, 2_s } });
	test_screen_1->adi_io->warning_altitude_disagree						<< test_generator_io->create_enum_socket<bool> ("adi/flags/altitude-disagree", { { false, 8_s }, { true, 2_s } });
	test_screen_1->adi_io->warning_roll										<< test_generator_io->create_enum_socket<bool> ("adi/flags/roll", { { false, 11_s }, { true, 2_s } });
	test_screen_1->adi_io->warning_slip_skid								<< test_generator_io->create_enum_socket<bool> ("adi/flags/slip-skid", { { false, 7.5_s }, { true, 2_s } });
	test_screen_1->adi_io->style_old										<< false;
	test_screen_1->adi_io->style_show_metric								<< true;

	test_screen_1->hsi_io->display_mode										<< hsi::DisplayMode::Auxiliary;
	...
	test_screen_1->engine_l_speed_io->value									<< test_generator_io->create_socket<si::AngularVelocity> ("engine/left/speed", 0.0_rpm, { -100_rpm, 15'000_rpm }, 1200_rpm / 1_s);

	test_screen_1->engine_l_temperature_io->value							<< test_generator_io->create_socket<si::Temperature> ("engine/left/temperature", 0_degC, { -20_degC, 75_degC }, 5_K / 1_s);

	test_screen_1->engine_l_power_io->value									<< test_generator_io->create_socket<si::Power> ("engine/left/power", 0_W, { 0_W, 295_W }, 11_W / 1_s);

	test_screen_1->engine_l_current_io->value								<< test_generator_io->create_socket<si::Current> ("engine/left/current", 0_A, { -5_A, 40_A }, 5_A / 1_s);

	test_screen_1->engine_l_voltage_io->value								<< test_generator_io->create_socket<si::Voltage> ("engine/left/voltage", 16.8_V, { 11.1_V, 16.8_V }, 0.07_V / 1_s);

	test_screen_1->engine_l_vibration_io->value								<< test_generator_io->create_socket<si::Acceleration> ("engine/left/vibration", 0.1_g, { 0.1_g, 1.2_g }, 0.025_g / 1_s);

	test_screen_1->engine_r_thrust_io->value								<< test_generator_io->create_socket<si::Force> ("engine/right/thrust", 0_N, { -0.3_N, 4.5_N }, 0.2_N / 1_s);
	test_screen_1->engine_r_thrust_io->reference							<< 4.1_N;
	test_screen_1->engine_r_thrust_io->target								<< 3.9_N;
	test_screen_1->engine_r_thrust_io->automatic							<< test_generator_io->create_socket<si::Force> ("engine/right/thrust/automatic", 2_N, { 1.5_N, 2.5_N }, 0.1_N / 1_s);

	test_screen_1->engine_r_speed_io->value									<< test_generator_io->create_socket<si::AngularVelocity> ("engine/right/speed", 0.0_rpm, { -100_rpm, 15'000_rpm }, 1200_rpm / 1_s);

	test_screen_1->engine_r_temperature_io->value							<< test_generator_io->create_socket<si::Temperature> ("engine/right/temperature", 0_degC, { -20_degC, 75_degC }, 5_K / 1_s);

	test_screen_1->engine_r_power_io->value									<< test_generator_io->create_socket<si::Power> ("engine/right/power", 0_W, { 0_W, 295_W }, 10_W / 1_s);

	test_screen_1->engine_r_current_io->value								<< test_generator_io->create_socket<si::Current> ("engine/right/current", 0_A, { -5_A, 40_A }, 5_A / 1_s);
	...
	test_screen_1->gear_io->nose_down										<< true;
	test_screen_1->gear_io->left_up											<< false;
	test_screen_1->gear_io->left_down										<< true;
	test_screen_1->gear_io->right_up										<< false;
	test_screen_1->gear_io->right_down										<< true;

	test_screen_1->vertical_trim_io->trim_value								<< test_generator_io->create_socket<double> ("vertical-trim", 0.0, { 0.0, 1.0 }, 0.1 / 1_s);
	test_screen_1->vertical_trim_io->trim_reference							<< 0.5;
	test_screen_1->vertical_trim_io->trim_reference_minimum					<< 0.35;
	test_screen_1->vertical_trim_io->trim_reference_maximum					<< 0.6;

	test_screen_1->glide_ratio_io->value									<< test_generator_io->create_socket<double> ("perf/glide-ratio", 50.0, { 15, 75 }, 3 / 1_s);
	test_screen_1->load_factor_io->value									<< test_generator_io->create_socket<double> ("perf/load-factor", 1.0, { 0.4, 3.3 }, 0.2 / 1_s);

	test_screen_2->hsi_1_io->display_mode									<< hsi::DisplayMode::Expanded;
	...
	test_screen_2->hsi_2_io->display_mode									<< hsi::DisplayMode::Rose;
