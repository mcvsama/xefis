...
TestScreen1::TestScreen1 (xf::ProcessingLoop& loop,
						  xf::ScreenSpec const& spec,
						  xf::Graphics const& graphics,
	...
	// Instruments:
	adi (loop, _graphics, "adi"),
	hsi (loop, _graphics, _navaid_storage, _logger, "hsi"),
	engine_l_thrust (loop, _graphics, nullptr, "engine.l.thrust"),
	engine_l_speed (loop, _graphics, to_n1, "engine.l.n1"),
	engine_l_power (loop, _graphics, nullptr, "engine.l.power"),
	...
	label_amps (loop, _graphics, "eicas.label.thrust"),
	label_temp (loop, _graphics, "eicas.label.temp"),
	label_volts (loop, _graphics, "eicas.label.volts"),
	label_vib (loop, _graphics, "eicas.label.vib"),
	gear (loop, _graphics, "gear"),
	flaps (loop, _graphics, "flaps"),
	vertical_trim (loop, _graphics, "eicas.trim.vertical"),
	horizontal_trim (loop, _graphics, "eicas.trim.horizontal"),
	glide_ratio (loop, _graphics, nullptr, "eicas.glide-ratio"),
