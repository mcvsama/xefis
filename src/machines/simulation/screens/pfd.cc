...
PrimaryFlightDisplay::PrimaryFlightDisplay (xf::ScreenSpec const& spec, xf::Graphics const& graphics, xf::NavaidStorage const& navaid_storage, xf::Machine& machine, xf::Logger const& logger):
	Screen (spec, graphics, machine, "Primary Flight Display", logger),
	_graphics (graphics),
	...
	_others_work_performer (1, logger.with_scope ("generic"))
{
	...
	engine_l_power_io->value_maximum							= 150_W;
	...
	engine_l_thrust_io->value_maximum_warning					= 30_N;
	engine_l_thrust_io->value_maximum							= 30_N;
	...
	engine_r_power_io->value_maximum							= 150_W;
	...
	engine_r_thrust_io->value_maximum_warning					= 30_N;
	engine_r_thrust_io->value_maximum							= 30_N;
...
PrimaryFlightDisplay::create_instruments()
{
...

	{
		...
		set_centered (**_engine_l_power, { r_start_pos + r_go_left + 0 * r_go_down, ri_size });
		...
		set_centered (**_engine_l_thrust, { r_start_pos + r_go_left + 2 * r_go_down, ri_size });
		...
		set_centered (**_engine_r_power, { r_start_pos + r_go_right + 0 * r_go_down, ri_size });
		...
		set_centered (**_engine_r_thrust, { r_start_pos + r_go_right + 2 * r_go_down, ri_size });
		...
		set_centered (**_label_pwr, { r_start_pos + 0 * r_go_down + r_go_label, label_size });
		...
		set_centered (**_label_thr, { r_start_pos + 2 * r_go_down + r_go_label, label_size });
