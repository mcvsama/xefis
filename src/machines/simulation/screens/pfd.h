...
#ifndef XEFIS__MACHINES__SIMULATION__SCREENS__PFD_H__INCLUDED
#define XEFIS__MACHINES__SIMULATION__SCREENS__PFD_H__INCLUDED
...
class PrimaryFlightDisplay: public xf::Screen
{
  public:
	// Ctor
	explicit
	PrimaryFlightDisplay (xf::ScreenSpec const&, xf::Graphics const& graphics, xf::NavaidStorage const&, xf::Machine&, xf::Logger const& logger);
