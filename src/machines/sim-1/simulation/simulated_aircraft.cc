...
make_aircraft (xf::rigid_body::System& rigid_body_system, xf::Atmosphere& simulated_atmosphere, xf::AntennaSystem& antenna_system)
{
	...
	auto prandtl_tube_params = xf::sim::PrandtlTubeParameters { .mass = 0.1_kg, .length = 20_cm, .diameter = 1_cm };
	auto& prandtl_tube = aircraft_group.add<xf::sim::PrandtlTube> (simulated_atmosphere, prandtl_tube_params); // TODO mass = 25 g
