...
#ifndef XEFIS__MACHINES__SIM_1__GROUND_STATION__RADIO_MACHINE__RADIO_MACHINE_H__INCLUDED
#define XEFIS__MACHINES__SIM_1__GROUND_STATION__RADIO_MACHINE__RADIO_MACHINE_H__INCLUDED
