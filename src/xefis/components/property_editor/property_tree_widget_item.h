...
#ifndef XEFIS__COMPONENTS__PROPERTY_EDITOR__PROPERTY_TREE_WIDGET_ITEM_H__INCLUDED
#define XEFIS__COMPONENTS__PROPERTY_EDITOR__PROPERTY_TREE_WIDGET_ITEM_H__INCLUDED
