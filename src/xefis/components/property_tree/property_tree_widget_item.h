...
#ifndef XEFIS__COMPONENTS__PROPERTY_TREE__PROPERTY_TREE_WIDGET_ITEM_H__INCLUDED
#define XEFIS__COMPONENTS__PROPERTY_TREE__PROPERTY_TREE_WIDGET_ITEM_H__INCLUDED
