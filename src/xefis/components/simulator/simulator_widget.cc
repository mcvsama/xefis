...
SimulatorWidget::make_viewer_widget()
{
	...
	_rigid_body_viewer->set_sun_enabled (true);
	_rigid_body_viewer->set_moon_enabled (true);
	_rigid_body_viewer->set_universe_enabled (true);
...
SimulatorWidget::make_body_controls()
{
	...
	_rigid_body_viewer->set_hovered_body_callback ([this] (rigid_body::Body const* body) {
