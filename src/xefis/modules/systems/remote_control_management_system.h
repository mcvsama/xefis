...
#ifndef XEFIS__MODULES__SYSTEMS__REMOTE_CONTROL_MANAGEMENT_SYSTEM_H__INCLUDED
#define XEFIS__MODULES__SYSTEMS__REMOTE_CONTROL_MANAGEMENT_SYSTEM_H__INCLUDED
