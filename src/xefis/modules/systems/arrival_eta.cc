...
ArrivalETA::compute()
{
	...
	try {
		...
		si::Angle station_bearing = nu::wrap_within_range<si::Angle> (xf::initial_bearing (aircraft, station), 0_deg, 360_deg);
		si::Angle angle_diff = nu::wrap_within_range<si::Angle> (station_bearing - *_io.track_lateral_true, -180_deg, +180_deg);
