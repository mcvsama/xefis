...
VOR::compute()
{
		...
		_io.input_radial_magnetic)
	{
		...
		si::Angle deviation = neutrino::wrap_within_range<si::Angle> (input_radial - current_radial, -180_deg, +180_deg);
...
{
	return neutrino::wrap_within_range<si::Angle> (a, 0_deg, 360_deg);
}
...
{
	return neutrino::wrap_within_range<si::Angle> (a, -180_deg, +180_deg);
}
