...
[[nodiscard]]
SunPosition
compute_sun_position (si::LonLat const observer_position, si::Time const);
...
compute_sun_light_color (si::LonLatRadius<> const observer_position, SpaceVector<double> const sun_position, AtmosphericScattering const&);
