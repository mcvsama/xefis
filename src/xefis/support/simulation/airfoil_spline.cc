...
PlaneVector<>
AirfoilSpline::projected_chord_and_thickness (si::Angle alpha, si::Angle beta) const
{
	...
	{
		auto rotated = z_rotation<AirfoilSplineFrame> (alpha) * Point::Resized<1, 3> { point[0], point[1], 0.0 };
