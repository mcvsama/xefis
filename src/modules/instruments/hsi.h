...
class HSI: public Xefis::Instrument
{
  ...
  private:
	...
	Xefis::PropertyBoolean	_navaid_visible;
	Xefis::PropertyString	_navaid_reference;
	Xefis::PropertyString	_navaid_identifier;
	Xefis::PropertyLength	_navaid_distance;
	Xefis::PropertyTime		_navaid_eta;
	Xefis::PropertyAngle	_navaid_course_magnetic;
	Xefis::PropertyBoolean	_navaid_left_visible;
	...
	Xefis::PropertyBoolean	_navaid_right_visible;
