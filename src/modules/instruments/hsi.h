...
class HSI: public Xefis::Instrument
{
  ...
  private:
	...
	Xefis::PropertyAngle	_pointer_green_primary;
	Xefis::PropertyAngle	_pointer_green_secondary;
	Xefis::PropertyAngle	_pointer_cyan_primary;
	Xefis::PropertyAngle	_pointer_cyan_secondary;
